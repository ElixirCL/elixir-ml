...
En un programa tradicional, se siguen reglas exactas.
Mientras que en un programa agéntico, se persiguen objetivos y 
se decide cómo alcanzarlos.
...
Elixir no es solo un lenguaje funcional elegante; su arquitectura lo convierte en un candidato natural para la programación agéntica:

* **Concurrencia masiva:** Los procesos ligeros de la BEAM permiten ejecutar miles de agentes simultáneos sin colapsar los recursos del sistema. Cada agente puede vivir en su propio proceso, con su propia memoria y ciclo de vida.
* **Tolerancia a fallos:** La filosofía _"let it crash"_ y los árboles de supervisión garantizan que si un agente falla, el sistema se recupera automáticamente. Un agente que se equivoca no arrastra a los demás.
* **Pattern matching:** La coincidencia de patrones es ideal para modelar la función de un agente: dado un percepto, seleccionar la acción correcta.
* **Distribución:** La BEAM puede ejecutar procesos en múltiples nodos, permitiendo sistemas multi-agente distribuidos de forma nativa.
...
Las herramientas agénticas son los entornos de desarrollo que integran modelos de lenguaje para asistir en la programación de forma interactiva.

Se puede ver los últimos modelos en la siguiente web https://hasbeenreleased.com/[Has been Released].

* https://claude.ai/code[**Claude Code**] — Agente de terminal de Anthropic, especializado en tareas de código complejas.
* https://cursor.com/[**Cursor**] — Editor de código con IA integrada, basado en VS Code.
* https://openai.com/codex[**Codex**] — Motor de generación de código de OpenAI, base de GitHub Copilot.

=== Modelos de Lenguaje Populares

Los modelos de lenguaje son las "inteligencias" que alimentan las herramientas agénticas. Cada uno tiene fortalezas distintas:

* **Sonnet** (Anthropic) — Equilibrio entre velocidad y calidad, ideal para tareas cotidianas.
* **Haiku** (Anthropic) — Modelo ligero y rápido para tareas simples.
* **GPT-4o** (OpenAI) — Modelo multimodal con capacidad de procesamiento de imágenes y audio.
* **Gemini** (Google) — Modelo con ventana de contexto extensa, ideal para análisis de proyectos grandes.

=== ¿Se pueden instalar modelos locales?
...
e instalar un modelo local como https://ollama.com/[oLlama], https://lmstudio.ai/[LMStudio] o https://pinokio.co/[Pinokio], para simular las capacidades de cómputo de un modelo de suscripción como https://www.anthropic.com/claude/opus[Opus 4.6] se necesitaría una inversión
...
de suscripción disponibles o por lo menos un híbrido entre opciones locales y la nube.
...
https://github.com/NousResearch/hermes-agent[Hermes Agent], https://opencode.ai/[OpenCode] y https://github.com/openclaw/openclaw[OpenClaw] son tres herramientas que permiten dar un contexto persistente a los modelos
...
_OpenClaw_, _OpenCode_ y _Hermes Agent_ se entienden mejor como tres prototipos tempranos e influyentes de infraestructura de agentes persistentes. Uno prioriza el ecosistema. Otro prioriza el ciclo de aprendizaje. Y el tercero la experiencia de terminal. Ninguno es un producto terminado, pero los tres apuntan hacia un futuro en el que los agentes de IA funcionen como servicios de larga duración en lugar de asistentes limitados a una sesión.
