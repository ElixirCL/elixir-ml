...
[TIP]
====
**Gestión de versiones:** Si trabajas en múltiples proyectos con distintas versiones de Elixir/Erlang, herramientas como https://asdf-vm.com/[asdf] o https://mise.jdx.dev/[mise] te permiten instalar y cambiar entre versiones fácilmente. Son la opción preferida en entornos profesionales.
