...
----
{
  "[elixir]": {
    ...
    "editor.defaultFormatter": "JakeBecker.elixir-ls"  // <2>
  },
...
----
<1> Formatea el código automáticamente cada vez que guardas.
<2> Usa ElixirLS como formateador (respeta `.formatter.exs`).
<3> Asocia los templates de Phoenix para tener resaltado de sintaxis.
...
| Alto rendimiento
| Tareas complejas, análisis profundo
|===
